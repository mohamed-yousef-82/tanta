...
class CentersController extends abstractController
{
  use InputFilter;
  use Helper;
  public $current_model = "project\models\CentersModel";
  public function defaultAction(){
      $this->data['centers'] = $this->current_model::select_items("","fetchAll");
      $this->view();
  }
  public function addAction(){
    if (isset($_POST['submit'])){
     ...
     if ($current_data->insert("")){
        ...
        $this->redirect('/tanta/tu/centers');
     }
    }
    $this->view();
}
public function editAction(){
  ...
  $this->data['centers'] = $this->current_model::select_items($id,"fetch");
  if ($this->data ===false){
      $this->redirect('/tanta/tu/centers');
  }
  if (isset($_POST['submit'])){
