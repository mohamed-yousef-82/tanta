...
class SpuniController extends abstractController
{
  use InputFilter;
  use Helper;
  public $current_model = "project\models\SpuniModel";
  public function defaultAction(){
      $this->data['spuni'] = $this->current_model::select_items("","fetchAll");
      $this->view();
  }
...
public function editAction(){
  ...
  $this->data['spuni'] = $this->current_model::select_items($id,"fetch");
  if ($this->data ===false){
      $this->redirect('/tanta/tu/spuni');
  }
  if (isset($_POST['submit'])){
