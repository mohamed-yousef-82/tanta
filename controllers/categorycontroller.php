  ...
  public function addAction(){
    if (isset($_POST['submit'])){
     ...
     if ($current_data->insert("")){
        ...
        $this->redirect('/tanta/tu/category');
     }
    }
    $this->view();
}
...
public function categoryAction(){
  $this->data['current_category_data'] = $this->current_model::select_items($this->current_cat_id,"fetch");
  $this->data['category_articles'] = $this->current_model::getCatArticles($this->current_cat_id);
    $this->view();
}
public function articleAction(){
  $this->data['article'] = $this->current_model::getArticle($this->current_article_id);
    $this->view();
}
