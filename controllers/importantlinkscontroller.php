...
class ImportantlinksController extends abstractController
{
  use InputFilter;
  use Helper;
  public $current_model = "project\models\ImportantlinksModel";
  public function defaultAction(){
      $this->data['importantlinks'] = $this->current_model::select_items("","fetchAll");
      $this->view();
  }
  public function addAction(){
    if (isset($_POST['submit'])){
     ...
     if ($current_data->insert("")){
        ...
        $this->redirect('/tanta/tu/importantlinks');
     }
    }
    $this->view();
}
public function editAction(){
  ...
  $this->data['importantlinks'] = $this->current_model::select_items($id,"fetch");
  if ($this->data ===false){
      $this->redirect('/tanta/tu/importantlinks');
  }
  if (isset($_POST['submit'])){
