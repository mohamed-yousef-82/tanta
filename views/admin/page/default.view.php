...
<tr>
<td><?= $number ?></td>
<td><?= $loop_data['title_ar'] ?></td>
<td><?= $loop_data['title_en'] ?></td>
<td><div class="fixedheight"><?= $loop_data['details_ar'] ?></div></td>
<td><div class="fixedheight"><?= $loop_data['details_en'] ?></div></td>
